...
import AdminMenu from "./AdminMenu"
 ...
 const ProductUpdate = () => {
  ...
  const [uploadProductImage] = useUploadProductMutation()
          ...
          <div className="md:w-3/4 p-3">
           ...
           <div className="mb-3">
            ...
            <div className="p-3">
              ...
              <textarea 
              type="text" 
              className="p-2 mb-3 bg-[#101011] 
              border rounded-lg w-[95%] text-white" 
              value={description} 
              onChange={(e) => setDescription(e.target.value)}
              ></textarea>
              
              <div className="flex justify space-x-12">
                <div>
                  <label htmlFor="name block">Count In Stock</label> <br />
                  <input type="text" className="p-4 mb-3 w-[30rem] border rounded-lg
                   bg-[#101011] text-white" value={stock}
